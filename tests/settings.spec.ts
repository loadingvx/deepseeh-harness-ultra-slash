...
import { CONFIGURABLE_DEFAULT_NAMES } from '../src/catalog.ts'
import { translate, type UltraSlashKey } from '../src/locales.ts'
import { builtinPayloadDefaults } from '../src/client/SettingsSection.tsx'
